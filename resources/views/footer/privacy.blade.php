...
<head>
    ...
    <!--コンテンツのCSS-->
    <link rel="stylesheet" href="/css/footer/privacy.css">
        ...
        <div class="backgroundimage">
            <div class="mainContents_container">
                ...
                <div class="mainContents_container_center">
                    <div class="mainContents_container_center_div">

                        <h1>プライバシーポリシー</h1>
                        <p>FF14-APP（以下，「当サイト」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</p>
                        ...
                        <p>Eメールアドレス：info@ff14-app.com</p>
