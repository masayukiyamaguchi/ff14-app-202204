        ...
        <div class="backgroundimage">
            <div class="mainContents_container">
                ...
                <div class="mainContents_container_left">
                    ...
                    @for ($i = 0; $i < 50; $i++)
                        <div class="playlist_contents{{ $i }}" click_num={{ $i }}>
                            <div class="playlist_div{{ $i }}">
                                <div class="samneil_div{{ $i }}">
                                    <img src="" alt="">
                                </div>
                            </div>

                            <div class="play_time{{ $i }}">

                            </div>

                            <div class="playlist_detail_div{{ $i }}">

                                <div class="playlist_title{{ $i }}">

                                </div>

                                <div class="playlist_detail_datas{{ $i }}">

                                    <div class="channnel_samneil{{ $i }}">
                                        <img src="" alt="">
                                    </div>


                                    <div class="playlist_detail_data_text{{ $i }}">
                                        <div class="playlist_detail_title{{ $i }}">

                                        </div>

                                        <div class="playlist_detail_data_text_num{{ $i }}">
                                            <div class="view_count{{ $i }}">

                                            </div>
                                            <div class="published_at{{ $i }}">
                            ...
                            <div class="view_url{{ $i }}">

                            </div>
                            <div class="movie_id{{ $i }}">
                ...
                <div class="mainContents_container_center">
                    ...
                    <div class="main_contents_div">
                        ...
                        <div class="search_word_div">

                            <div class="search_word_input_div">
                                <input class="search_word_input" type="text" name="search_word_input" value="絶竜詩戦争">
                            </div>
                            <div class="search_word_button_div">
                                <button class="search_word_button">
                                    検索
                                </button>
                    ...
                    <div class="play_moniter">
                        <iframe width="2000" height="1125" wmode="Opaque" src="" title="YouTube video player"
                    ...
                    <div id="root">
                        <div id="target">
                            ...
                            <div class="formfield">
                                ...
                                <div class="formfield_inputfield_div">
                                    ...
                                    <div class="formfield_inputfield">
                                        ...
                                        <div class="formfield_inputfield_form">
                                                ...
                                                <div class="language">
                                                    <div class="language_input">
                                                        ...
                                                        <select name="language" id="language">
                                                            <option class="language_jp" value="language_jp">日本語
                                                            </option>
                                                            <option class="language_en" value="language_en">英語
                                                            </option>
                                                            <option class="language_ot" value="language_ot">その他
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
                            ...
                            -->
                                ...
                                -->
                                            ...
                                            <div class="contents">
                                                ...
                                                <div class="contents_input_contentsname">
                                                    <select name="contentsname" id="contentsname">
                                                        <option value="UltimateDragoonWar"
                                                            class="endwalker displaynone">
                                                            絶・竜詩戦争
                                                        </option>
                                                        <option value="Asphodelos" class="endwalker displaynone">辺獄編
                                                        </option>

                                                        <option value="Purgatory" class="endwalker displaynone">煉獄編
                                                        </option>

                                                        <option value="EndwalkerExtreme"
                                                            class="endwalker displaynone">
                                                            極討滅戦
                                                        </option>
                                                        <option value="EndwalkerUnreal" class="endwalker displaynone">
                                                            幻討滅戦
                                                        </option>
                                                        <option value="EdensPromise"
                                                            class="shadowbringers displaynone">
                                                            再生編
                                                        </option>
                                                        <option value="EdensVerse" class="shadowbringers displaynone">
                                                            共鳴編
                                                        </option>
                                                        <option value="EdensGate" class="shadowbringers displaynone">
                                                            覚醒編
                                                        </option>
                                                        <option value="Alphascape" class="stormblood displaynone">
                                                            アルファ編
                                                        </option>
                                                        <option value="Sigmascape" class="stormblood displaynone">シグマ編
                                                        </option>
                                                        <option value="Deltascape" class="stormblood displaynone">デルタ編
                                                        </option>
                                                        <option value="TheSouloftheCreator"
                                                            class="heavensward displaynone">
                                                            天動編
                                                        </option>
                                                        <option value="TheBurdenoftheSon"
                                                            class="heavensward displaynone">
                                                            律動編
                                                        </option>
                                                        <option value="TheFistoftheFather"
                                                            class="heavensward displaynone">起動編
                                                        </option>
                                                        <option value="TheFinalCoilofBahamut"
                                                            class="arealmreborn displaynone">真成編
                                                        </option>
                                                        <option value="TheSecondCoilofBahamut"
                                                            class="arealmreborn displaynone">
                                                            侵攻編</option>
                                                        <option value="TheBindingCoilofBahamut"
                                                            class="arealmreborn displaynone">
                                                            邂逅編</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="contents_input_contents">
                                                    <select name="contents" id="contents">
                                                        ...
                                                        <option value="Asphodelos01" class="Asphodelos displaynone">1層
                                                        </option>
                                                        <option value="Asphodelos02" class="Asphodelos displaynone">2層
                                                        </option>
                                                        <option value="Asphodelos03" class="Asphodelos displaynone">3層
                                                        </option>
                                                        <option value="Asphodelos04" class="Asphodelos displaynone">
                                                            4層前半
                                                        </option>
                                                        <option value="Asphodelos05" class="Asphodelos displaynone">
                                                            4層後半
                                                        </option>
                                                        <option value="Asphodelos06" class="Asphodelos displaynone">
                                                            4層前後半
                                                        </option>

                                                        <option value="Purgatory01" class="Purgatory displaynone">1層
                                                        </option>
                                                        <option value="Purgatory02" class="Purgatory displaynone">2層
                                                        </option>
                                                        <option value="Purgatory03" class="Purgatory displaynone">3層
                                                        </option>
                                                        <option value="Purgatory04" class="Purgatory displaynone">4層前半
                                                        </option>
                                                        <option value="Purgatory05" class="Purgatory displaynone">4層後半
                                                        </option>
                                                        <option value="Purgatory06" class="Purgatory displaynone">
                                                            4層前後半
                                                        </option>

                                                        <option value="EndwalkerExtreme01"
                                                            class="EndwalkerExtreme displaynone">
                                                            極ゾディアーク</option>
                                                        <option value="EndwalkerExtreme02"
                                                            class="EndwalkerExtreme displaynone">
                                                            極ハイデリン</option>
                                                        <option value="EndwalkerExtreme03"
                                                            class="EndwalkerExtreme displaynone">
                                                            終焉を謳うもの</option>
                                                        <option value="EndwalkerExtreme04"
                                                            class="EndwalkerExtreme displaynone">
                                                            極バルバリシア</option>
                                                        <option value="EndwalkerUnreal01"
                                                            class="EndwalkerUnreal displaynone">
                                                            幻魔人セフィロト</option>
                                                        <option value="EdensPromise01"
                                                            class="EdensPromise displaynone">1層
                                                        </option>
                                                        <option value="EdensPromise02"
                                                            class="EdensPromise displaynone">2層
                                                        </option>
                                                        <option value="EdensPromise03"
                                                            class="EdensPromise displaynone">3層
                                                        </option>
                                                        <option value="EdensPromise04"
                                                            class="EdensPromise displaynone">
                                                            4層前半
                                                        </option>
                                                        <option value="EdensPromise05"
                                                            class="EdensPromise displaynone">
                                                            4層後半
                                                        </option>
                                                        <option value="EdensPromise06"
                                                            class="EdensPromise displaynone">
                                                            4層前後半
                                                        </option>
                                                        <option value="EdensVerse01" class="EdensVerse displaynone">1層
                                                        </option>
                                                        <option value="EdensVerse02" class="EdensVerse displaynone">2層
                                                        </option>
                                                        <option value="EdensVerse03" class="EdensVerse displaynone">3層
                                                        </option>
                                                        <option value="EdensVerse04" class="EdensVerse displaynone">4層
                                                        </option>
                                                        <option value="EdensGate01" class="EdensGate displaynone">1層
                                                        </option>
                                                        <option value="EdensGate02" class="EdensGate displaynone">2層
                                                        </option>
                                                        <option value="EdensGate03" class="EdensGate displaynone">3層
                                                        </option>
                                                        <option value="EdensGate04" class="EdensGate displaynone">4層
                                                        </option>
                                                        <option value="Alphascape01" class="Alphascape displaynone">1層
                                                        </option>
                                                        <option value="Alphascape02" class="Alphascape displaynone">2層
                                                        </option>
                                                        <option value="Alphascape03" class="Alphascape displaynone">3層
                                                        </option>
                                                        <option value="Alphascape04" class="Alphascape displaynone">
                                                            4層前半
                                                        </option>
                                                        <option value="Alphascape05" class="Alphascape displaynone">
                                                            4層後半
                                                        </option>
                                                        <option value="Alphascape06" class="Alphascape displaynone">
                                                            4層前後半
                                                        </option>
                                                        <option value="Sigmascape01" class="Sigmascape displaynone">1層
                                                        </option>
                                                        <option value="Sigmascape02" class="Sigmascape displaynone">2層
                                                        </option>
                                                        <option value="Sigmascape03" class="Sigmascape displaynone">3層
                                                        </option>
                                                        <option value="Sigmascape04" class="Sigmascape displaynone">
                                                            4層前半
                                                        </option>
                                                        <option value="Sigmascape05" class="Sigmascape displaynone">
                                                            4層後半
                                                        </option>
                                                        <option value="Sigmascape06" class="Sigmascape displaynone">
                                                            4層前後半
                                                        </option>
                                                        <option value="Deltascape01" class="Deltascape displaynone">1層
                                                        </option>
                                                        <option value="Deltascape02" class="Deltascape displaynone">2層
                                                        </option>
                                                        <option value="Deltascape03" class="Deltascape displaynone">3層
                                                        </option>
                                                        <option value="Deltascape04" class="Deltascape displaynone">
                                                            4層前半
                                                        </option>
                                                        <option value="Deltascape05" class="Deltascape displaynone">
                                                            4層後半
                                                        </option>
                                                        <option value="Deltascape06" class="Deltascape displaynone">
                                                            4層前後半
                                                        </option>
                                                        ...
                                                        <option value="TheBurdenoftheSon01"
                                                            class="TheBurdenoftheSon displaynone">
                                                            1層</option>
                                                        <option value="TheBurdenoftheSon02"
                                                            class="TheBurdenoftheSon displaynone">
                                                            2層</option>
                                                        <option value="TheBurdenoftheSon03"
                                                            class="TheBurdenoftheSon displaynone">
                                                            3層</option>
                                                        <option value="TheBurdenoftheSon04"
                                                            class="TheBurdenoftheSon displaynone">
                                                            4層</option>
                                            ...
                                            <div class="formfield_submit_button">
                                                <button>送信します</button>
                                                <div class="ajax_done">登録しました</div>
                                                <div class="ajax_error">エラーが発生しました</div>
                                            </div>
